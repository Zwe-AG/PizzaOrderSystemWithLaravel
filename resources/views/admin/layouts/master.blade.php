            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="{{ route('list#page') }}" style="text-decoration:none">
                        ...
                        <li>
                            <a href="{{ route('contact#list') }}" style="text-decoration:none">
                                <i class="fa-regular fa-address-book"></i> Contact List
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('userlist#page') }}" style="text-decoration:none">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            @if (Auth::user()->gender == 'male')
                                                <img src="{{ asset('image/defaultimg.jpeg') }}" class="img-thumbnail"/>
                                            @else
                                                <img src="{{ asset('image/female.jpeg') }}" class="img-thumbnail"/>
                                            @endif
                                            @else
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#accountdetail') }}" class="text-decoration-none">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <button type="submit" class="p-2 m-3">
                                                        <i class="zmdi zmdi-power ml-2 mr-4"></i>Logout
                                                    </button>
                                                </form>
                                            </div>
                                        </div>

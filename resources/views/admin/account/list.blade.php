        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <h4 class="text-danger"> <i class="fa-solid fa-database"></i> Total - {{ $admins->total() }}</h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="spacer">
                                    <tr class="tr-shadow">
                                        <td class="col-2">
                                            @if($admin->image != null)
                                                <img src="{{ asset('storage/'.$admin->image) }}" class="img-thumbnail shadow-sm" style="height:100px;width:100px;object-fit:cover"/>
                                            @else
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                ...
                                                <a href="{{ route('admin#changerole',$admin->id) }}">
                                                    <button title="Role Change">
                                                        <i class="fa-solid fa-right-left ms-3 mt-1"></i>
                                                    </button>
                                                </a>
                                                @endif
                                            </div>
